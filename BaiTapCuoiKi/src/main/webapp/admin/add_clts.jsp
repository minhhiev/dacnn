			...
			<div class="col-md-4 offset-md-4">
				<div class="card">
					<div class="card-body">
						...
						<form action="../add_clts" method="post"
							...
							<div class="form-group">
								<label for="inputState">clother Type</label> <select
									id="inputState" name="btype" class="form-control">
									<option selected>--select--</option>
									<option value="Vip">skirt</option>
									<option value="Type1">shirt</option>
                                    <option value="Type2">desses</option>
								</select>
							</div>
