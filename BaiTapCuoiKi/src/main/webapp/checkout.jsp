				...
				<div class="card">
					<div class="card-body">
						...
						<input type="hidden" value="${userobj.id}" name="id">
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									<label for="inputEmail4">Booking Date</label> <input type="datetime-local" name="state"
										class="form-control" id="inputEmail4" required >
								</div>
								<div class="form-group col-md-6">
									<label for="inputPassword4">CheckOut Date</label> <input type="datetime-local" name="pincode"
										class="form-control" id="inputPassword4" required>
								</div>
							...
							<div class="form-group">
								<label>Payment Mode</label> <select class="form-control" name="payment">
									...
									<option value="COD">Cash On Checkout</option>
								</select>
							</div>


							<div class="text-center">
								<button class="btn btn-warning">Booking Now</button>
